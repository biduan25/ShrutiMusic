...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "akuuzp")
BOT_USERNAME = os.getenv("BOT_USERNAME", "biduan1bot")
...
SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/museumzp")
